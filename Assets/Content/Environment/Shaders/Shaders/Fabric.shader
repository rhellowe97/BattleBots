Shader "URPPlus/Fabric"
{
    Properties
    {
        ...
        // Material Type
        [HideInInspector] _MaterialType("Material Type", Float) = 0.0
        [ToggleUI] _Translucency("Translucency", Float) = 0.0
        // Alpha Clipping
        ...
        _TranslucencyColor("Translucency Color", Color) = (1.0, 1.0, 1.0)
        ...
        _FuzzMapScale("Fuzz Map Scale", Float) = 1.0
        _FuzzStrength("Thread Normal Scale", Range(0.0, 1.0)) = 0.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local_fragment _SHEENMAP
            #pragma shader_feature_local _NORMALMAP
            #pragma shader_feature_local_fragment _THICKNESSMAP

            #pragma shader_feature_local_fragment _THREADMAP
        ...
        Pass
        {
            ...
            #include "ShaderLibrary/Fabric/FabricInput.hlsl"
            #include "ShaderLibrary/Fabric/FabricMetaPass.hlsl"
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.FabricGUI"
}
