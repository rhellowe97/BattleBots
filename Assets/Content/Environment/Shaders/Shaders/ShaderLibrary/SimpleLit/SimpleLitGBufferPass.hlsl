...
FragmentOutput LitGBufferPassFragment(Varyings input, half faceSign : VFACE)
{
    ...
    half3 color = GlobalIllumination(brdfData, inputData.bakedGI, inputData.positionWS, surfaceData.geomNormalWS, inputData.normalWS, inputData.viewDirectionWS, surfaceData.occlusion, surfaceData.horizonFade);
