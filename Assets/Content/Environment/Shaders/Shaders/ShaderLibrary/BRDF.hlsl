...
half3 EnvironmentBRDFIridescence(BRDFData brdfData, half3 indirectDiffuse, half3 indirectSpecular, half fresnelTerm, half3 fresnelIridescent)
{
    half3 c = indirectDiffuse * brdfData.diffuse;
    float surfaceReduction = 1.0 / (brdfData.roughness2 + 1.0);
    c +=  indirectSpecular * (surfaceReduction * lerp(brdfData.specular * Pow5(fresnelIridescent), brdfData.grazingTerm, fresnelIridescent));
    return c;
}
