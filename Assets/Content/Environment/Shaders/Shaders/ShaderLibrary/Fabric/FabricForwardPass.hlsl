...
#if defined(_NORMALMAP) || defined(_THREADMAP) || defined(_DOUBLESIDED_ON) || defined(_MATERIAL_FEATURE_ANISOTROPY)
...
half4 LitPassFragment(Varyings input, half faceSign : VFACE) : SV_Target
{
    ...
    half4 color = FabricFragment(inputData, surfaceData, tangentWS);
