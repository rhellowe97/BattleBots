...
void LitPassFragment(Varyings input, half faceSign : VFACE, out float4 outColor : SV_Target
...
)
{
    ...
    half4 color = LitFragment(inputData, surfaceData, coatNormalWS, bentNormalWS);
