...
#if defined(_NORMALMAP) || defined(_DETAIL) || defined(_DOUBLESIDED_ON) || ((defined(_CLEARCOAT) || defined(_CLEARCOATMAP)) && defined(_CLEARCOAT_NORMALMAP)) || (defined(_BENTNORMAL_SPECULAR_OCCLUSION) && defined(_BENTNORMALMAP))  || defined(_PIXEL_DISPLACEMENT)
...
void InitializeInputData(Varyings input, SurfaceData surfaceData, out real3 coatNormalWS, out real3 bentNormalWS, out InputData inputData)
{
...
)
{
    ...
    InitializeInputData(input, surfaceData, coatNormalWS, bentNormalWS, inputData);
    ...
    InitializeVectorsData(vectorsData, inputData.normalWS, inputData.normalWS, coatNormalWS, bentNormalWS, inputData.viewDirectionWS, 0.0);

    Light mainLight = GetMainLight(inputData.shadowCoord, inputData.positionWS, inputData.shadowMask);
    MixRealtimeAndBakedGI(mainLight, inputData.normalWS, inputData.bakedGI, inputData.shadowMask);
    half3 color = GlobalIllumination(brdfData, brdfDataClearCoat, vectorsData, inputData.positionWS, inputData.bakedGI, surfaceData.clearCoatMask, surfaceData.occlusion, surfaceData.horizonFade, surfaceData.giOcclusionBias);
